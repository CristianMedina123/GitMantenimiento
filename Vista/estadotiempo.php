	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-info"></i> Estados de <small>Los Tiempos ANLI</small></h1>
			</div>
			<p class="lead">El estado de Ticket es para poder identificar el estatus en que se encuentra el ticket, si se está atendiendo, si no se está atendiendo o ya se completó el proceso.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	<li class="active"><a href="#new" data-toggle="tab">Nuevo Estado de Tiempo</a></li>
					  	<li><a href="#list" data-toggle="tab">Lista Estados de Tiempo</a></li>
					</ul>
						...
						<div class="tab-pane fade active in" id="new">
									...
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form>
											<div class="form-group label-floating">
											  ...
											  <input class="form-control" id="txtEstadoTiempo" autocomplete="off">
											</div>
										    <p class="text-center">
										    	<button type="button" onclick="InsertarEstadoTiempo()" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Save</button>
										    </p>
									    </form>
									</div>
								</div>
					  	...
					  	<div class="tab-pane fade" id="list">
							<div class="table-responsive">
								<table id="id_tabla_estadoTiempo" class="dipslay table table-hover text-center" style="width:100%">
									<thead>
										<tr>
											<th class="text-center">Estado de Tiempo</th>
		...
		<div class="modal-dialog">
			...
			<div class="modal-header">
				<h2 class="modal-title" id="exampleModalLabel">Editar Estado de Tiempo</h2>
			...
			<div class="modal-footer">
				...
				<button type="button" onclick="ActualizarEstadoTiempo()" class="btn btn-primary">Guardar Cambios</button>
			</div>
			</div>
		</div>
		</div>
...
<?php } ?>
	...
	<script src="../Controlador/ControladorEstadoTiempo.js"></script>
	<script>
		$.material.init();
	</script>
</body>
