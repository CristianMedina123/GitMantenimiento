	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-info"></i> Estados de <small>Los Ticket ANLI</small></h1>
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	<li class="active"><a href="#new" data-toggle="tab">Nuevo Estado de Ticket</a></li>
					  	<li><a href="#list" data-toggle="tab">Lista Estados de Ticket</a></li>
					</ul>
						...
						<div class="tab-pane fade active in" id="new">
									...
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form>
											<div class="form-group label-floating">
											  ...
											  <input type="text" class="form-control" id="txtEstadoTicket" autocomplete="off">
											</div>
										    <p class="text-center">
										    	<button type="button" onclick="InsertarEstadoTicket()" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Save</button>
										    </p>
									    </form>
									</div>
								</div>
					  	...
					  	<div class="tab-pane fade" id="list">
							<div class="table-responsive">
								<!-- <table id="id_tabla_estado_centro" class="table table-hover text-center display"> -->
                                <table id="id_tabla_estadoticket" class="display table table-hover text-center" style="width:100%">
                                    <thead>
                                        <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLabel">Editar Estado de Ticket</h2>
...
<?php } ?>
	...
	<script src="../Controlador/ControladorEstadoTicket.js"></script>
