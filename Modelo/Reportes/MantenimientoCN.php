...
function Header(){
    ...
    $this->Ln(20);
    $this->Cell(20,10,'Equipo', 1, 0, 'C', 0);
    $this->Cell(20,10,'Codigo', 1, 0, 'C', 0);
    $this->Cell(25,10,'Modelo', 1, 0, 'C', 0);
    $this->Cell(30,10,'Centro Negocio', 1, 0, 'C', 0);
    $this->Cell(20,10,'Estado', 1, 0, 'C', 0);
    $this->Cell(15,10,'Fecha', 1, 0, 'C', 0);
    $this->Cell(25,10,'Mantenimiento', 1, 0, 'C', 0);
    $this->Cell(40,10,'Desc.', 1, 1, 'C', 0);
...
$query = mysqli_query($conn, "SELECT equipo.Equipo, equipo.Codigo, equipo.Modelo,centronegocio.CentroNegocio, centronegocio.Estado, mantenimiento.FechaMantenimiento, mantenimiento.mantenimiento ,mantenimiento.Descripcion FROM mantenimiento
INNER JOIN equipo
...
WHERE IdCentroNegocio = $cn ORDER BY FechaMantenimiento DESC");
