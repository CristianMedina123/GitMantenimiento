...
$query = mysqli_query($conn, "SELECT ticket.TicketNom,ticket.Fecha,ticket.Fecha,estadoticket, usuario.Nombre, usuario.ApellidoPat, usuario.ApellidoMat FROM ticket
INNER JOIN usuario
