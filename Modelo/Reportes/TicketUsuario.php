...
$query = mysqli_query($conn, "SELECT ticket.Ticket, ticket.Descripcion, ticket.FechaTicket, estadoticket.EstadoTicket ,usuario.Nombre, usuario.ApellidoPa, usuario.ApellidoMa FROM ticket
INNER JOIN usuario
