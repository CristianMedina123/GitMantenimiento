...
$query = mysqli_query($conn, "SELECT equipo.Equipo, equipo.Codigo, equipo.Modelo,equipo.Marca,centronegocio.CentroNegocio, centronegocio.EstadoCN,  tipoestado.TipoEstado FROM equipo
