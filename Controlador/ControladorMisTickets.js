...
function ActualizarMisTickets() {
    var id = $('#txtIdTicketEditar').val();
    var obspendiente = $("#txtObsPendienteEditar").val();
    var estado = $("#slcEstadoEditar").val();

if( obspendiente.lenght < 3 || obspendiente.lenght === 0 || estado.lenght < 3 || estado.lenght === 0){
    alertify.alert('Ocurrió un error','No puede dejar campos vacíos', function(){ alertify.error('¡Error!'); }).set('closable', false);
        ...
        $.ajax({
        type: "POST",
            url: "../Modelo/ActualizarMisTicket.php",
            data: cadena,
            success: function (res)
            {
                if (res == 1) {
...
function EditarMisTicketsProceso(id) {
...
function ActualizarMisTicketsProceso() {
    var id = $('#txtIdTicketEditarProceso').val();
    var obspendiente = $("#txtObsPendienteProcesoEditarProceso").val();
    var estado = $("#slcEstadoEditarProceso").val();
    if( obspendiente.lenght < 3 || obspendiente.lenght === 0 || estado.lenght < 3 || estado.lenght === 0){
        alertify.alert('Ocurrió un error','No puede dejar campos vacíos', function(){ alertify.error('¡Error!'); }).set('closable', false);
    }else {
        ...
        $.ajax({
        type: "POST",
            url: "../Modelo/ActualizarMisTicketProceso.php",
            data: cadena,
            success: function (res)
            {
                if (res == 1) {
                    $("#ModalActualizarProcesoTickets").modal("hide");
                    alertify.success('¡Se actualizó el registro!'); 
                    setTimeout(function(){ location.reload(); }, 2000);
                } else {
                    alertify.success('¡Ocurrió un error! Intentelo más tarde');
...
function EditarMisTicketsHecho(id) {
...
function ActualizarMisTicketsHecho() {
    var id = $('#txtIdTicketEditarProcesoHecho').val();
    var obspendiente = $("#txtObsPendienteHechosEditarProceso").val();
    var estado = $("#slcEstadoEditarHecho").val();
    ...
    if( obspendiente.lenght < 3 || obspendiente.lenght === 0 || estado.lenght < 3 || estado.lenght === 0){
        ...
        $.ajax({
        type: "POST",
            url: "../Modelo/ActualizarMisTickeHecho.php",
            data: cadena,
            success: function (res)
            {
                if (res == 1) {
                    $("#ModalActualizarHechoTickets").modal("hide");
                    alertify.success('¡Se actualizó el registro!'); 
                    setTimeout(function(){ location.reload(); }, 2000);
                } else {
                    alertify.success('¡Ocurrió un error! Intentelo más tarde');
...
$(document).ready(function () {
    ...
    $('#id_tabla_misticketHecho').DataTable({
        language: {
            aria: {
                sortAscending: "Activar para ordenar la columna de manera ascendente",
                sortDescending: "Activar para ordenar la columna de manera descendente"
    ...
    $('#id_tabla_misticketPendiente').DataTable({
        language: {
            aria: {
                sortAscending: "Activar para ordenar la columna de manera ascendente",
                sortDescending: "Activar para ordenar la columna de manera descendente"
